...
pizzas = [
    ...
    [3, "Margarita", "Familiar", 11000],
    [4, "Mexicana", "Pequeña", 7000],
    [5, "Mexic1ana", "Mediana", 10000],
...
def datos_pizzas():
    ...
    #row bucle que revisa todo lo guardado en "ventas registradas"
    for row in pizzas:
        print(row, "\n")
...
def registrar_venta():
    ...
    rut = input("Por favor escriba su RUT: ")
    nombre = input("Por favor escriba nombre: ")
...
def generar_factura(datos_ventas):
    ...
    print("==================================")
    print("¡Muchas gracias por su compra en Pizzas Duoc!")
    print("**********************************\n")
...
while True:
    ...
    if opcion == 1:
        ...
        if ventas_cliente:
            ...
            print("\nNo se encontraron ventas para el RUT dado.")
